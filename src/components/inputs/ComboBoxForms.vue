<template>
  <v-combobox v-model="dataSelected" :items="items" chips class="ml-auto" v-bind="$attrs" @change="onChange">
    <template v-slot:selection="data">
      <v-chip :key="JSON.stringify(data.item.value)" v-bind="data.attrs" :input-value="data.selected"
        :disabled="data.disabled" @click:close="data.parent.selectItem(data.item.value)">
