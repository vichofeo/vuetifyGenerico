    ...
    <v-hover v-slot="{ hover }" open-delay="200" >
        ...
        <v-expand-transition>
            <div class="d-flex grow flex-wrap">
                ...
                <v-avatar v-if="avatar" size="128" class="mx-auto v-card--material __avatar elevation-6" color="white" tile>
                    <v-img :src="avatar" />
                </v-avatar>

                <v-sheet v-else :class="{'pa-7': !$slots.image, '__headingOffset': (hover && !!$slots['reveal-actions']) }" 
                rounded
                :color="color" 
                ...
                <div v-else-if="icon && title" class="ml-4">
                    <div class="card-title font-weight-bold" style="color: rgb(29, 98, 161);" v-text="title" />
                </div>
