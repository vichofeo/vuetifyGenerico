    ...
    <div>
        <header class="text-caption"> 
            ...
            <v-form ref="form" v-model="valid" lazy-validation>
                <div align="center" v-if="$store.state.optionsServiceInterOp.selectedMore.title=='BDPA'">
                    <v-avatar class="profile" color="grey" height="128" width="300" tile>
                            <v-img contain :src="avatarSearch" style="background:white;" max-height="128" max-width="300"></v-img>
                        </v-avatar>
                ...
                <v-row align="start" align-content="start" justify="center"   >                    
                    <!--<v-col cols="12" xs="12" sm="12" md="12" xl="1" lg="1" class="text-primary text-center" align-self="start">
                        <v-avatar class="profile" color="grey" size="50" tile>
                            <v-img :src="avatarSearch" style="background:white;"></v-img>
                        </v-avatar> {{ titlSearch }}
                    </v-col>-->
                    <v-col cols="12" xs="12" sm="12" md="12" xl="2" lg="2" class="text-caption" align-self="end" v-if="extension">
                    ...
                    <v-col cols="12" xs="12" sm="12" md="12" xl="3" lg="3" class="text-caption" align-self="end">
...
export default {
    ...
    methods: {
        ...
        clicHere() {
            ...
            datos.ci = this.numero_documento
            ...
            if (this.fecha_nacimiento != null && this.fecha_nacimiento != '') {
                ...
                if (utils.validaFechaIn(this.fecha_nacimiento)) {                                        
