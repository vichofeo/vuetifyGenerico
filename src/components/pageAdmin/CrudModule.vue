                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-text-field v-model="editedItem.nombre_modulo" label="Nombre Modulo"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-text-field v-model="editedItem.path_page" label="Path Acceso"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-text-field v-model="editedItem.layout" label="Nombre layout"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Nuevo Modulo' : 'Editar Modulo'
        },
    },
